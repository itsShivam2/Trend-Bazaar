          ...
          <Tabs defaultIndex={0} className=" ">
            <TabList className="md:flex md:space-x-8 bg-  grid grid-cols-2 text-center gap-4   md:justify-center mb-10 ">
              <Tab>
                <button
                  type="button"
                  className="min-w-[150px] font-medium border-b-2 hover:shadow-purple-700 border-purple-500 text-purple-500 rounded-lg text-xl shadow-[inset_0_0_8px_rgba(0,0,0,0.6)]  px-5 py-1.5 text-center bg-[#605d5d12] "
                >
                  <div className="flex gap-2 items-center">
                    <IconsAndImages.MdOutlineProductionQuantityLimits />
                    Products
                  </div>{" "}
                </button>
              </Tab>
                ...
                <div className=" flex justify-end">
                  <Link to={"/admin/addproduct"}>
                    ...
                    >
                      {" "}
                      <div className="flex gap-2 items-center">
                        Add Product <IconsAndImages.FaCartPlus size={20} />
                      </div>
                    </button>
                  </Link>
                </div>
